...
class TestUpload:
    ...
    def test_upload(self, video_data: dict):
        ...
        # image select
        image_selector = '#basicField > div.gr.select-video-image > div:nth-child(2) > div.radio._mt60.thumbs > div:nth-child(2)'
        # identifying the source element
        self.driver.find_element(By.CSS_SELECTOR, image_selector).find_element(By.TAG_NAME, 'input').click()
...
if __name__ == '__main__':
    ...
    main(True) # time.time() < 1676822321+604800)
